...
type Client struct {
	...
	copyrightPublicKey *rsa.PublicKey
}
...
func New(appId, privateKey, publicKey string, isProd bool, opts ...OptionFunc) (client *Client, e *BizErr) {
	...
	client.copyrightPublicKey = pubKey
...
func (c *Client) URLValues(method string, params map[string]interface{}) (value url.Values, e *BizErr) {
	...
	enData, err := encryptWithPKCS1v15(bytes, c.copyrightPublicKey)
	if err != nil {
...
func (c *Client) doRequest(method string, params map[string]interface{}, result interface{}) (e *BizErr) {
	...
	c.logger.Infof("Copyright api data decrypted content: %s", content)
...
func (c *Client) VerifySign(data url.Values) (ok bool, e *BizErr) {
	ok, src, err := verifySign(data, c.copyrightPublicKey)
	if err != nil {
